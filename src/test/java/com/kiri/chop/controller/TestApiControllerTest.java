...
public class TestApiControllerTest {
	...
	public void Test_save() throws Exception {
		...
		TestSaveRequestDto requestDto = TestSaveRequestDto.builder()
				.title(title)
				.content(content)
				.author("author")
				.build();
	...
	public void Test_update() throws Exception {
		//given
		TestEntity savedEntity = testRepository.save(TestEntity.builder()
				.title("title")
				.content("content")
				.author("author")
				.build());
		
		Long updateId = savedEntity.getId();
		String expectedTitle = "title2";
		String expectedContent = "content2";
		
		TestUpdateRequestDto requestDto = TestUpdateRequestDto.builder()
				.title(expectedTitle)
				.content(expectedContent)
				.build();
		
		String url = "http://localhost:" + port + "/api/v1/test/" + updateId;
		
		HttpEntity<TestUpdateRequestDto> requestEntity = new
